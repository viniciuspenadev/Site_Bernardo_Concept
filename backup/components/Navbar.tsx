    ...
    >
      <div className="container mx-auto px-6 lg:px-12 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-4 flex-1 justify-end">
          ...
          {/* Glass Pill Button */}
          <a href="#" className={`ml-4 text-[10px] font-bold uppercase tracking-widest px-6 py-2.5 rounded-full transition-all duration-300 border ${isScrolled
      ...
      <div className={`fixed inset-0 bg-primary-900/95 backdrop-blur-xl z-40 transition-transform duration-500 md:hidden flex flex-col items-center justify-center ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex flex-col gap-8 text-center">
          ...
          <button className="mt-8 px-10 py-4 bg-white text-primary-900 rounded-full uppercase tracking-widest text-xs font-bold hover:scale-105 transition-transform">
            Agendar Visita
          </button>
        </div>
      </div>
